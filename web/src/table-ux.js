...
const TABLE_MESSAGES = {
    en: {
        ...
        recordsJSONDescription: 'Retrieve minimally transformed source records as a JSON array',
        productsJSONDescription: 'Retrieve the KALA product projection when available',
        recordsCSVDescription: 'Download all database records in CSV format',
        productSyncDescription: 'Retrieve the compatibility replication envelope when available',
        ...
        exportExcelMacroWorkbook: 'Download macro-enabled workbook',
        exportExcelMacroWorkbookDescription: 'Trusted XLSM populated with current records',
        exportExcelMacroTemplate: 'Download macro-enabled template',
        exportExcelMacroTemplateDescription: 'Configured data-empty XLTM',
    ...
    fa: {
        ...
        recordsJSONDescription: 'دریافت رکوردهای منبع با کمترین تبدیل به‌صورت آرایه JSON',
        productsJSONDescription: 'دریافت نمای محصولات KALA در صورت موجودبودن',
        recordsCSVDescription: 'دریافت همه رکوردهای پایگاه‌داده با قالب CSV',
        productSyncDescription: 'دریافت بسته سازگاری همگام‌سازی در صورت موجودبودن',
        ...
        exportExcelMacroWorkbook: 'دریافت فایل ماکرو‌دار XLSM',
        exportExcelMacroWorkbookDescription: 'فایل مورد اعتماد با داده‌های جاری',
        exportExcelMacroTemplate: 'دریافت الگوی ماکرو‌دار XLTM',
        exportExcelMacroTemplateDescription: 'الگوی پیکربندی‌شده و بدون داده',
