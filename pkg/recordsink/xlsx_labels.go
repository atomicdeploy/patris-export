...
var xlsxColumnLabels = map[string]xlsxLocalizedLabel{
	...
	"irt_per_cny":                    {English: "IRT per CNY", Persian: "نرخ یوان (تومان)"},
	...
	"price_source_amount":            {English: "Selected Price Amount", Persian: "مبلغ منبع قیمت"},
	"price_source_currency":          {English: "Selected Price Currency", Persian: "ارز منبع قیمت"},
	"price_source_kind":              {English: "Selected Price Source", Persian: "نوع منبع قیمت"},
	"price_rounding_digits":          {English: "Price Rounding Digits", Persian: "تعداد رقم گردکردن قیمت"},
	"price_rounding_mode":            {English: "Price Rounding Mode", Persian: "روش گردکردن قیمت"},
	"final_price":                    {English: "Final Price (IRT)", Persian: "قیمت نهایی (تومان)"},
